...
- [[#wish-list][Wish-list]]
  ...
  - [[#disable-gc-at-startup-for-faster-startup-time][disable gc at startup for faster startup-time]]
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq-default
   ...
   fringes-outside-margins t)                       ; places the git gutter outside the margins.
  ...
  ;; Recentf:
  (recentf-mode 1)
  (setq recentf-max-menu-items 50)        ; Enlarge number of recent files
  (setq recentf-max-saved-items 50)

  ;; Don't show message, when saving recentf-list
...
** TODO disable gc at startup for faster startup-time
