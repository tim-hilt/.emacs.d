...
- [[#wish-list][Wish-list]]
  - [[#cancelled-cursor-jumps-around-when-writing-use-package][CANCELLED Cursor jumps around when writing "use-package"]]
  ...
  - [[#same-kind-of-overview-when-switching-buffers-as-in-doom-emacs][Same kind of overview, when switching buffers as in doom-emacs]]
  ...
  - [[#add-highlight-todo][Add Highlight-TODO]]
  - [[#cancelled-clean-up-dashboard][CANCELLED Clean up Dashboard]]
...
* Wish-list
** CANCELLED Cursor jumps around when writing "use-package"
- State "CANCELLED"  from "TODO"       [2020-02-13 Do 20:44] \\
  Not noticed for a while... Maybe a bug got resolved
...
** DONE Configure visual regexp steroids correctly
...
** TODO Same kind of overview, when switching buffers as in doom-emacs
- State "TODO"       from              [2020-01-20 Mo 20:57]
** TODO Find out, why maximized Emacs doesn't fill the whole screen everytime
** DONE Add Highlight-TODO
** CANCELLED Clean up Dashboard
- State "CANCELLED"  from "TODO"       [2020-02-12 Mi 08:56] \\
  Deleted Dashboard altogether
