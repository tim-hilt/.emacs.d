...
- [[#wish-list][Wish-list]]
  ...
  - [[#split-org-mode-code-block-to-the-right][Split org-mode code-block to the right]]
  ...
  - [[#same-kind-of-overview-when-switching-buffers][Same kind of overview, when switching buffers]]
...
** TODO Split org-mode code-block to the right
...
** TODO doom-emacs-level linting with hovers and shit
- State "TODO"       from              [2020-01-20 Mo 20:56]
** TODO Same kind of overview, when switching buffers
